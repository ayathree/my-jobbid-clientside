...
const Register = () => {
    ...
    return (
        <div>
            <div className="flex flex-row-reverse w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl  min-h-[calc(100vh-306px)] my-12">
      <div className="hidden bg-cover lg:block lg:w-1/2"
       style={{

        backgroundImage: `url('https://images.pexels.com/photos/6612792/pexels-photo-6612792.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`
